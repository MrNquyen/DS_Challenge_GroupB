...
from modelv2 import SacarsmOutput

logger = logging.getLogger("mmsd.predictorv2")
...
class MemoEnhancedPredictor(nn.Module):
    ...
    def forward(self, batch: SacarsmModelInput) -> tuple[Tensor, Tensor, Tensor]:
